...
sys_env_destroy(envid_t envid)
{
  ...
  800a6a:	68 c4 11 80 00       	push   $0x8011c4
  800a6f:	6a 23                	push   $0x23
  800a71:	68 e1 11 80 00       	push   $0x8011e1
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800aeb:	68 c4 11 80 00       	push   $0x8011c4
  800af0:	6a 23                	push   $0x23
  800af2:	68 e1 11 80 00       	push   $0x8011e1
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b2d:	68 c4 11 80 00       	push   $0x8011c4
  800b32:	6a 23                	push   $0x23
  800b34:	68 e1 11 80 00       	push   $0x8011e1
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b6f:	68 c4 11 80 00       	push   $0x8011c4
  800b74:	6a 23                	push   $0x23
  800b76:	68 e1 11 80 00       	push   $0x8011e1
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bb1:	68 c4 11 80 00       	push   $0x8011c4
  800bb6:	6a 23                	push   $0x23
  800bb8:	68 e1 11 80 00       	push   $0x8011e1
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800bf3:	68 c4 11 80 00       	push   $0x8011c4
  800bf8:	6a 23                	push   $0x23
  800bfa:	68 e1 11 80 00       	push   $0x8011e1
...
sys_ipc_recv(void *dstva)
{
  ...
  800c57:	68 c4 11 80 00       	push   $0x8011c4
  800c5c:	6a 23                	push   $0x23
  800c5e:	68 e1 11 80 00       	push   $0x8011e1
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c8c:	56                   	push   %esi
  800c8d:	50                   	push   %eax
  800c8e:	68 f0 11 80 00       	push   $0x8011f0
