...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d3f:	75 52                	jne    800d93 <set_pgfault_handler+0x61>
		// First time through!
  ...
  800d57:	79 12                	jns    800d6b <set_pgfault_handler+0x39>
			panic("sys_page_alloc: %e", r);
  800d59:	50                   	push   %eax
  800d5a:	68 6f 13 80 00       	push   $0x80136f
  800d5f:	6a 23                	push   $0x23
  800d61:	68 82 13 80 00       	push   $0x801382
  800d66:	e8 b7 f3 ff ff       	call   800122 <_panic>
		if ((r = sys_env_set_pgfault_upcall(0, _pgfault_upcall)) < 0)
  800d6b:	83 ec 08             	sub    $0x8,%esp
  800d6e:	68 9d 0d 80 00       	push   $0x800d9d
  800d73:	6a 00                	push   $0x0
  800d75:	e8 12 ff ff ff       	call   800c8c <sys_env_set_pgfault_upcall>
  800d7a:	83 c4 10             	add    $0x10,%esp
  800d7d:	85 c0                	test   %eax,%eax
  800d7f:	79 12                	jns    800d93 <set_pgfault_handler+0x61>
			panic("sys_env_set_pgfault_upcall: %e", r);	
  800d81:	50                   	push   %eax
  800d82:	68 90 13 80 00       	push   $0x801390
  800d87:	6a 25                	push   $0x25
  800d89:	68 82 13 80 00       	push   $0x801382
  800d8e:	e8 8f f3 ff ff       	call   800122 <_panic>
	}
...
_pgfault_upcall:
  ...
  800da5:	83 c4 04             	add    $0x4,%esp
	...
	movl 48(%esp), %eax
  800da8:	8b 44 24 30          	mov    0x30(%esp),%eax
	subl $4, %eax
  800dac:	83 e8 04             	sub    $0x4,%eax
	movl 40(%esp), %edx
  800daf:	8b 54 24 28          	mov    0x28(%esp),%edx
	movl %edx, (%eax)
