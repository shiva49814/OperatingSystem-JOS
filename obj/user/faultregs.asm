...
pgfault(struct UTrapframe *utf)
{
  ...
  800436:	68 9f 15 80 00       	push   $0x80159f
  80043b:	68 ad 15 80 00       	push   $0x8015ad
  800440:	b9 60 20 80 00       	mov    $0x802060,%ecx
  800445:	ba 98 15 80 00       	mov    $0x801598,%edx
  ...
  80046c:	50                   	push   %eax
  80046d:	68 b4 15 80 00       	push   $0x8015b4
  800472:	6a 5c                	push   $0x5c
  800474:	68 87 15 80 00       	push   $0x801587
...
umain(int argc, char **argv)
{
  ...
  80055a:	68 14 16 80 00       	push   $0x801614
  ...
  800574:	68 c7 15 80 00       	push   $0x8015c7
  800579:	68 d8 15 80 00       	push   $0x8015d8
  80057e:	b9 20 20 80 00       	mov    $0x802020,%ecx
  800583:	ba 98 15 80 00       	mov    $0x801598,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80060b:	56                   	push   %esi
  80060c:	50                   	push   %eax
  80060d:	68 40 16 80 00       	push   $0x801640
  ...
  80061e:	e8 54 00 00 00       	call   800677 <vcprintf>
	cprintf("\n");
  800623:	c7 04 24 50 15 80 00 	movl   $0x801550,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80072b:	e8 60 0b 00 00       	call   801290 <__udivdi3>
  ...
  80076e:	e8 4d 0c 00 00       	call   8013c0 <__umoddi3>
  800773:	83 c4 14             	add    $0x14,%esp
  800776:	0f be 80 63 16 80 00 	movsbl 0x801663(%eax),%eax
  80077d:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800872:	ff 24 85 20 17 80 00 	jmp    *0x801720(,%eax,4)
  ...
  800936:	8b 14 85 80 18 80 00 	mov    0x801880(,%eax,4),%edx
  80093d:	85 d2                	test   %edx,%edx
  80093f:	75 18                	jne    800959 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800941:	50                   	push   %eax
  800942:	68 7b 16 80 00       	push   $0x80167b
  800947:	53                   	push   %ebx
  800948:	56                   	push   %esi
  ...
  800959:	52                   	push   %edx
  80095a:	68 84 16 80 00       	push   $0x801684
  80095f:	53                   	push   %ebx
  800960:	56                   	push   %esi
  ...
  80097e:	b8 74 16 80 00       	mov    $0x801674,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ff9:	68 a4 18 80 00       	push   $0x8018a4
  800ffe:	6a 23                	push   $0x23
  801000:	68 c1 18 80 00       	push   $0x8018c1
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8010bc:	68 a4 18 80 00       	push   $0x8018a4
  8010c1:	6a 23                	push   $0x23
  8010c3:	68 c1 18 80 00       	push   $0x8018c1
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8010fe:	68 a4 18 80 00       	push   $0x8018a4
  801103:	6a 23                	push   $0x23
  801105:	68 c1 18 80 00       	push   $0x8018c1
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  801140:	68 a4 18 80 00       	push   $0x8018a4
  801145:	6a 23                	push   $0x23
  801147:	68 c1 18 80 00       	push   $0x8018c1
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  801182:	68 a4 18 80 00       	push   $0x8018a4
  801187:	6a 23                	push   $0x23
  801189:	68 c1 18 80 00       	push   $0x8018c1
...
sys_ipc_recv(void *dstva)
{
  ...
  8011ed:	68 c1 18 80 00       	push   $0x8018c1
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801205:	83 3d d0 20 80 00 00 	cmpl   $0x0,0x8020d0
  80120c:	75 52                	jne    801260 <set_pgfault_handler+0x61>
		// First time through!
  ...
  80121a:	e8 31 fe ff ff       	call   801050 <sys_page_alloc>
		if (r < 0)
  80121f:	83 c4 10             	add    $0x10,%esp
  801222:	85 c0                	test   %eax,%eax
  801224:	79 12                	jns    801238 <set_pgfault_handler+0x39>
			panic("sys_page_alloc: %e", r);
  801226:	50                   	push   %eax
  801227:	68 b4 15 80 00       	push   $0x8015b4
  80122c:	6a 23                	push   $0x23
  80122e:	68 cf 18 80 00       	push   $0x8018cf
  801233:	e8 b7 f3 ff ff       	call   8005ef <_panic>
		if ((r = sys_env_set_pgfault_upcall(0, _pgfault_upcall)) < 0)
  801238:	83 ec 08             	sub    $0x8,%esp
  80123b:	68 6a 12 80 00       	push   $0x80126a
  801240:	6a 00                	push   $0x0
  801242:	e8 12 ff ff ff       	call   801159 <sys_env_set_pgfault_upcall>
  801247:	83 c4 10             	add    $0x10,%esp
  80124a:	85 c0                	test   %eax,%eax
  80124c:	79 12                	jns    801260 <set_pgfault_handler+0x61>
			panic("sys_env_set_pgfault_upcall: %e", r);	
  80124e:	50                   	push   %eax
  80124f:	68 e0 18 80 00       	push   $0x8018e0
  801254:	6a 25                	push   $0x25
  801256:	68 cf 18 80 00       	push   $0x8018cf
  80125b:	e8 8f f3 ff ff       	call   8005ef <_panic>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  801260:	8b 45 08             	mov    0x8(%ebp),%eax
  801263:	a3 d0 20 80 00       	mov    %eax,0x8020d0
}
  801268:	c9                   	leave  
  801269:	c3                   	ret    
...
_pgfault_upcall:
  ...
  80126b:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax
  ...
  801272:	83 c4 04             	add    $0x4,%esp
	...
	movl 48(%esp), %eax
  801275:	8b 44 24 30          	mov    0x30(%esp),%eax
	subl $4, %eax
  801279:	83 e8 04             	sub    $0x4,%eax
	movl 40(%esp), %edx
  80127c:	8b 54 24 28          	mov    0x28(%esp),%edx
	movl %edx, (%eax)
  801280:	89 10                	mov    %edx,(%eax)
	movl %eax, 48(%esp)
