...
sys_env_destroy(envid_t envid)
{
  ...
  800b17:	68 24 13 80 00       	push   $0x801324
  800b1c:	6a 23                	push   $0x23
  800b1e:	68 41 13 80 00       	push   $0x801341
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b98:	68 24 13 80 00       	push   $0x801324
  800b9d:	6a 23                	push   $0x23
  800b9f:	68 41 13 80 00       	push   $0x801341
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bda:	68 24 13 80 00       	push   $0x801324
  800bdf:	6a 23                	push   $0x23
  800be1:	68 41 13 80 00       	push   $0x801341
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c5e:	68 24 13 80 00       	push   $0x801324
  800c63:	6a 23                	push   $0x23
  800c65:	68 41 13 80 00       	push   $0x801341
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ca0:	68 24 13 80 00       	push   $0x801324
  800ca5:	6a 23                	push   $0x23
  800ca7:	68 41 13 80 00       	push   $0x801341
...
sys_ipc_recv(void *dstva)
{
  ...
  800d04:	68 24 13 80 00       	push   $0x801324
  800d09:	6a 23                	push   $0x23
  800d0b:	68 41 13 80 00       	push   $0x801341
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d2a:	75 52                	jne    800d7e <set_pgfault_handler+0x61>
		// First time through!
  ...
  800d42:	79 12                	jns    800d56 <set_pgfault_handler+0x39>
			panic("sys_page_alloc: %e", r);
  800d44:	50                   	push   %eax
  800d45:	68 4f 13 80 00       	push   $0x80134f
  800d4a:	6a 23                	push   $0x23
  800d4c:	68 62 13 80 00       	push   $0x801362
  800d51:	e8 b7 f3 ff ff       	call   80010d <_panic>
		if ((r = sys_env_set_pgfault_upcall(0, _pgfault_upcall)) < 0)
  800d56:	83 ec 08             	sub    $0x8,%esp
  800d59:	68 88 0d 80 00       	push   $0x800d88
  800d5e:	6a 00                	push   $0x0
  800d60:	e8 12 ff ff ff       	call   800c77 <sys_env_set_pgfault_upcall>
  800d65:	83 c4 10             	add    $0x10,%esp
  800d68:	85 c0                	test   %eax,%eax
  800d6a:	79 12                	jns    800d7e <set_pgfault_handler+0x61>
			panic("sys_env_set_pgfault_upcall: %e", r);	
  800d6c:	50                   	push   %eax
  800d6d:	68 70 13 80 00       	push   $0x801370
  800d72:	6a 25                	push   $0x25
  800d74:	68 62 13 80 00       	push   $0x801362
  800d79:	e8 8f f3 ff ff       	call   80010d <_panic>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  800d7e:	8b 45 08             	mov    0x8(%ebp),%eax
  800d81:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800d86:	c9                   	leave  
  800d87:	c3                   	ret    

00800d88 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800d89:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800d90:	83 c4 04             	add    $0x4,%esp
	...
	movl 48(%esp), %eax
  800d93:	8b 44 24 30          	mov    0x30(%esp),%eax
	subl $4, %eax
  800d97:	83 e8 04             	sub    $0x4,%eax
	movl 40(%esp), %edx
  800d9a:	8b 54 24 28          	mov    0x28(%esp),%edx
	movl %edx, (%eax)
  800d9e:	89 10                	mov    %edx,(%eax)
	movl %eax, 48(%esp)
  800da0:	89 44 24 30          	mov    %eax,0x30(%esp)

	// Restore the trap-time registers.  After you do this, you
	// can no longer modify any general-purpose registers.
	// LAB 4: Your code here.
	addl $8, %esp
  800da4:	83 c4 08             	add    $0x8,%esp
	popal
  800da7:	61                   	popa   
