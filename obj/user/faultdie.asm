...
sys_env_destroy(envid_t envid)
{
  ...
  800aa8:	e8 86 02 00 00       	call   800d33 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b29:	e8 05 02 00 00       	call   800d33 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b6b:	e8 c3 01 00 00       	call   800d33 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bad:	e8 81 01 00 00       	call   800d33 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bef:	e8 3f 01 00 00       	call   800d33 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c31:	e8 fd 00 00 00       	call   800d33 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800c95:	e8 99 00 00 00       	call   800d33 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800caf:	75 52                	jne    800d03 <set_pgfault_handler+0x61>
		// First time through!
  ...
  800cc7:	79 12                	jns    800cdb <set_pgfault_handler+0x39>
			panic("sys_page_alloc: %e", r);
  800cc9:	50                   	push   %eax
  800cca:	68 af 12 80 00       	push   $0x8012af
  800ccf:	6a 23                	push   $0x23
  800cd1:	68 c2 12 80 00       	push   $0x8012c2
  800cd6:	e8 58 00 00 00       	call   800d33 <_panic>
		if ((r = sys_env_set_pgfault_upcall(0, _pgfault_upcall)) < 0)
  800cdb:	83 ec 08             	sub    $0x8,%esp
  800cde:	68 0d 0d 80 00       	push   $0x800d0d
  800ce3:	6a 00                	push   $0x0
  800ce5:	e8 12 ff ff ff       	call   800bfc <sys_env_set_pgfault_upcall>
  800cea:	83 c4 10             	add    $0x10,%esp
  800ced:	85 c0                	test   %eax,%eax
  800cef:	79 12                	jns    800d03 <set_pgfault_handler+0x61>
			panic("sys_env_set_pgfault_upcall: %e", r);	
  800cf1:	50                   	push   %eax
  800cf2:	68 d0 12 80 00       	push   $0x8012d0
  800cf7:	6a 25                	push   $0x25
  800cf9:	68 c2 12 80 00       	push   $0x8012c2
  800cfe:	e8 30 00 00 00       	call   800d33 <_panic>
	}
...
_pgfault_upcall:
  ...
  800d0e:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800d1c:	83 e8 04             	sub    $0x4,%eax
	movl 40(%esp), %edx
  800d1f:	8b 54 24 28          	mov    0x28(%esp),%edx
	movl %edx, (%eax)
  800d23:	89 10                	mov    %edx,(%eax)
	movl %eax, 48(%esp)
  800d25:	89 44 24 30          	mov    %eax,0x30(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d37:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800d38:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800d3b:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800d41:	e8 6f fd ff ff       	call   800ab5 <sys_getenvid>
  800d46:	83 ec 0c             	sub    $0xc,%esp
  800d49:	ff 75 0c             	pushl  0xc(%ebp)
  800d4c:	ff 75 08             	pushl  0x8(%ebp)
  800d4f:	56                   	push   %esi
  800d50:	50                   	push   %eax
  800d51:	68 f0 12 80 00       	push   $0x8012f0
  800d56:	e8 10 f4 ff ff       	call   80016b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800d5b:	83 c4 18             	add    $0x18,%esp
  800d5e:	53                   	push   %ebx
  800d5f:	ff 75 10             	pushl  0x10(%ebp)
  800d62:	e8 b3 f3 ff ff       	call   80011a <vcprintf>
	cprintf("\n");
  800d67:	c7 04 24 3a 10 80 00 	movl   $0x80103a,(%esp)
  800d6e:	e8 f8 f3 ff ff       	call   80016b <cprintf>
  800d73:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800d76:	cc                   	int3   
  800d77:	eb fd                	jmp    800d76 <_panic+0x43>
