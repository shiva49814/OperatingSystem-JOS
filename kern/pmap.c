...
mem_init(void)
{
	...
	//kern_pgdir - initial page directory
	//KSTACKTOP-KSTKSIZE - VA from here we want to map KSTACKTOP = KERNBASE 
	//KSTKSIZE - velkost, the size we want to map   8*pagesize
	//PADDR(bootstack) - Use the physical memory that 'bootstack' refers to as the kernel stack.
